...
public:
    ...
    int UnpacketRecordPlan(const char *pszBuffer, STRU_SD_RECORD_PLAN &t);
    int UnpacketMotionRecordPlan(const char *pszBuffer, STRU_SD_RECORD_PLAN &t);
    int UnpacketMotionPushPlan(const char *pszBuffer, STRU_SD_RECORD_PLAN &t);
};