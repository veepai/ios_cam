...
int CCgiPacket::UnpacketStatusParam(const char *pszBuffer, STRU_CAMERA_STATUS &t)
{
    ...
    */
    ...
    {
        if (!SscanfString(pszBuffer, "app_version=", t.appver)) {
            strcpy(t.appver, "non");
        }
        if (!SscanfString(pszBuffer, "oem_id=", t.oemid)) {
            strcpy(t.oemid, "non");
        }
        if (SscanfInt(pszBuffer,"sdstatus=",t.sdcardstatus) && SscanfInt(pszBuffer,"sdlevel=",t.sdcardremainsize)) {
            return 1;//老固件
        }else{
            if (SscanfInt(pszBuffer, "record_sd_status=", t.sdcardstatus) && SscanfInt(pszBuffer, "sdfree=", t.sdcardremainsize)) {
                return 1;//新固件
            }
        }
    }
...
int CCgiPacket::UnpacketSdCardRecordFileList(const char * pszBuffer,STRU_RECORD_FILE_LIST & t)
{
   ...
   // NSLog(@"n = %d",n);
    ...
    /*页号*/
    int pageindex = 0;
    SscanfInt(pszBuffer, "PageIndex=", pageindex);
    /*总页数*/
    int pagecount = 0;
    SscanfInt(pszBuffer, "PageCount=", pagecount);
    /*录像文件总数*/
    int recordcount = 0;
    SscanfInt(pszBuffer, "RecordCount=", recordcount);
    /*每页的文件个数*/
    int pagesize = 0;
    SscanfInt(pszBuffer, "PageSize=", pagesize);
    if (pagesize == 0) {
        pagesize = n;
    }else{
        pagesize = (pagesize > MAX_RECORD_FILE_COUNT ? MAX_RECORD_FILE_COUNT : pagesize);
        t.nRecordCount = recordcount;
    }
    
    t.nPageCount = pagecount;
    t.nPageIndex = pageindex;
    
    if (pagesize > 0) {
        t.nPageSize = pagesize;
        nSize = (n < pagesize) ? n : pagesize;
    }
    t.nCount = nSize;
...
int CCgiPacket::UnpacketRecordPlan(const char *pszBuffer, STRU_SD_RECORD_PLAN &t)
{
    if (SscanfInt(pszBuffer, "record_plan1=", t.record_plan1)&&
        SscanfInt(pszBuffer, "record_plan2=", t.record_plan2)&&
        SscanfInt(pszBuffer, "record_plan3=", t.record_plan3)&&
        SscanfInt(pszBuffer, "record_plan4=", t.record_plan4)&&
        SscanfInt(pszBuffer, "record_plan5=", t.record_plan5)&&
        SscanfInt(pszBuffer, "record_plan6=", t.record_plan6)&&
        SscanfInt(pszBuffer, "record_plan7=", t.record_plan7)&&
        SscanfInt(pszBuffer, "record_plan8=", t.record_plan8)&&
        SscanfInt(pszBuffer, "record_plan9=", t.record_plan9)&&
        SscanfInt(pszBuffer, "record_plan10=", t.record_plan10)&&
        SscanfInt(pszBuffer, "record_plan11=", t.record_plan11)&&
        SscanfInt(pszBuffer, "record_plan12=", t.record_plan12)&&
        SscanfInt(pszBuffer, "record_plan13=", t.record_plan13)&&
        SscanfInt(pszBuffer, "record_plan14=", t.record_plan14)&&
        SscanfInt(pszBuffer, "record_plan15=", t.record_plan15)&&
        SscanfInt(pszBuffer, "record_plan16=", t.record_plan16)&&
        SscanfInt(pszBuffer, "record_plan17=", t.record_plan17)&&
        SscanfInt(pszBuffer, "record_plan18=", t.record_plan18)&&
        SscanfInt(pszBuffer, "record_plan19=", t.record_plan19)&&
        SscanfInt(pszBuffer, "record_plan20=", t.record_plan20)&&
        SscanfInt(pszBuffer, "record_plan21=", t.record_plan21)&&
        SscanfInt(pszBuffer, "record_plan_enable=", t.record_plan_enable)&&
        SscanfString(pszBuffer, "mask=", t.mask)
        ) {
        return 1;
    }
    else
...
int CCgiPacket::UnpacketMotionRecordPlan(const char *pszBuffer, STRU_SD_RECORD_PLAN &t)
{
    if (SscanfInt(pszBuffer, "motion_record_plan1=", t.record_plan1)&&
        SscanfInt(pszBuffer, "motion_record_plan2=", t.record_plan2)&&
        SscanfInt(pszBuffer, "motion_record_plan3=", t.record_plan3)&&
        SscanfInt(pszBuffer, "motion_record_plan4=", t.record_plan4)&&
        SscanfInt(pszBuffer, "motion_record_plan5=", t.record_plan5)&&
        SscanfInt(pszBuffer, "motion_record_plan6=", t.record_plan6)&&
        SscanfInt(pszBuffer, "motion_record_plan7=", t.record_plan7)&&
        SscanfInt(pszBuffer, "motion_record_plan8=", t.record_plan8)&&
        SscanfInt(pszBuffer, "motion_record_plan9=", t.record_plan9)&&
        SscanfInt(pszBuffer, "motion_record_plan10=", t.record_plan10)&&
        SscanfInt(pszBuffer, "motion_record_plan11=", t.record_plan11)&&
        SscanfInt(pszBuffer, "motion_record_plan12=", t.record_plan12)&&
        SscanfInt(pszBuffer, "motion_record_plan13=", t.record_plan13)&&
        SscanfInt(pszBuffer, "motion_record_plan14=", t.record_plan14)&&
        SscanfInt(pszBuffer, "motion_record_plan15=", t.record_plan15)&&
        SscanfInt(pszBuffer, "motion_record_plan16=", t.record_plan16)&&
        SscanfInt(pszBuffer, "motion_record_plan17=", t.record_plan17)&&
        SscanfInt(pszBuffer, "motion_record_plan18=", t.record_plan18)&&
        SscanfInt(pszBuffer, "motion_record_plan19=", t.record_plan19)&&
        SscanfInt(pszBuffer, "motion_record_plan20=", t.record_plan20)&&
        SscanfInt(pszBuffer, "motion_record_plan21=", t.record_plan21)&&
        SscanfInt(pszBuffer, "motion_record_enable=", t.record_plan_enable)&&
        SscanfString(pszBuffer, "mask=", t.mask)
        ) {
        return 1;
    }
...
int CCgiPacket::UnpacketMotionPushPlan(const char *pszBuffer, STRU_SD_RECORD_PLAN &t)
{
    if (SscanfInt(pszBuffer, "motion_push_plan1=", t.record_plan1)&&
        SscanfInt(pszBuffer, "motion_push_plan2=", t.record_plan2)&&
        SscanfInt(pszBuffer, "motion_push_plan3=", t.record_plan3)&&
        SscanfInt(pszBuffer, "motion_push_plan4=", t.record_plan4)&&
        SscanfInt(pszBuffer, "motion_push_plan5=", t.record_plan5)&&
        SscanfInt(pszBuffer, "motion_push_plan6=", t.record_plan6)&&
        SscanfInt(pszBuffer, "motion_push_plan7=", t.record_plan7)&&
        SscanfInt(pszBuffer, "motion_push_plan8=", t.record_plan8)&&
        SscanfInt(pszBuffer, "motion_push_plan9=", t.record_plan9)&&
        SscanfInt(pszBuffer, "motion_push_plan10=", t.record_plan10)&&
        SscanfInt(pszBuffer, "motion_push_plan11=", t.record_plan11)&&
        SscanfInt(pszBuffer, "motion_push_plan12=", t.record_plan12)&&
        SscanfInt(pszBuffer, "motion_push_plan13=", t.record_plan13)&&
        SscanfInt(pszBuffer, "motion_push_plan14=", t.record_plan14)&&
        SscanfInt(pszBuffer, "motion_push_plan15=", t.record_plan15)&&
        SscanfInt(pszBuffer, "motion_push_plan16=", t.record_plan16)&&
        SscanfInt(pszBuffer, "motion_push_plan17=", t.record_plan17)&&
        SscanfInt(pszBuffer, "motion_push_plan18=", t.record_plan18)&&
        SscanfInt(pszBuffer, "motion_push_plan19=", t.record_plan19)&&
        SscanfInt(pszBuffer, "motion_push_plan20=", t.record_plan20)&&
        SscanfInt(pszBuffer, "motion_push_plan21=", t.record_plan21)&&
        SscanfInt(pszBuffer, "motion_push_enable=", t.record_plan_enable)&&
        SscanfString(pszBuffer, "mask=", t.mask)
        ) {
        return 1;
    }
