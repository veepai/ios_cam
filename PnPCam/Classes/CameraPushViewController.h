...
@interface CameraPushViewController : UIViewController <UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, SearchAddCameraInfoProtocol, UINavigationBarDelegate,ScanStringDelegate> {
