...
static signed int gs_index_adjust[8]= {-1,-1,-1,-1,2,4,6,8};
static signed int gs_step_table[89] =
{
...
void CAdpcm::DecoderGetIndex(signed int * sample, signed int * index)
{
    *sample = m_nDeAudioPreSample;
    *index = m_nDeAudioIndex;
}

void CAdpcm::EncoderGetIndex(signed int * sample, signed int * index)
{
    *sample = m_nEnAudioPreSample;
    *index = m_nEnAudioIndex;
}
